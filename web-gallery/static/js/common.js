    ...
    Element.addMethods({
        wait: function (c, a) {
            ...
            var d = Builder.node("div", {
                ...
                src: doxStaticFilePath + "/images/progress_bubbles.gif",
                width: "29",
                height: "6",
                alt: ""
            })]);
...
var DoxClient = {
    ...
    openOrFocus: function (c) {
        if (DoxClient.nowOpening) {
            return
        }
        DoxClient.nowOpening = true;
        var e = (c.href ? c.href : c);
        if (screen.width < 990) {
            e += ((e.indexOf("?") != -1) ? "&" : "?") + "wide=false"
        }
        var d = DoxClient._openEmptyHabboWindow(DoxClient.windowName);
        var b = false;
        try {
            b = (d.DoxClient && d.document.doxLoggedIn)
        } catch (a) {}
        if (b && !DoxClient.forceReload) {
            d.focus()
        } else {
            d.location.href = e;
            d.focus()
        }
        DoxClient.nowOpening = false;
        Cookie.set("DoxClient", "1")
    },
    close: function (c) {
        var a = Cookie.get("DoxClient");
        if (a || c) {
            var b = DoxClient._openEmptyHabboWindow(DoxClient.windowName);
            if (!c) {
                Cookie.erase("DoxClient")
            }
            if (b && !b.closed) {
                b.close()
            }
    ...
    closeHabboAndOpenMainWindow: function (a) {
        if (window.opener != null && !window.opener.closed) {
            ...
            var b = window.open(a.href, "_blank", DoxClient.windowParams + (screen.width >= 990 ? DoxClient.wideSizeParams : DoxClient.narrowSizeParams));
            b.focus()
        }
        window.close()
    },
    _openHabboWindow: function (a, c) {
        if (DoxClient.maximizeWindow) {
            if (supportsHtml5Storage()) {
                html5StorageSetItem("maximizeWindow", "true");
                var b = DoxClient.getStoredWindowSize();
                if (b.length == 2) {
                    return window.open(a, c, DoxClient.windowParams + "width=" + b[0] + ",height=" + b[1])
                }
            }
            return window.open(a, c, DoxClient.windowParams + "top=0,left=0,width=" + window.screen.availWidth + ",height=" + window.screen.availHeight)
        } else {
            return window.open(a, c, DoxClient.windowParams + (screen.width >= 990 ? DoxClient.wideSizeParams : DoxClient.narrowSizeParams))
        }
    },
    ...
    _openEmptyHabboWindow: function (a) {
        return DoxClient._openHabboWindow("", a)
    },
...
function openOrFocusHabbo(a) {
    DoxClient.openOrFocus(a)
}

function roomForward(c, b, a) {
    DoxClient.roomForward(c, b, a)
}

function openOrFocusHelp(c) {
    var e = (c.href ? c.href : c);
    var d = DoxClient._openEmptyHabboWindow("habbohelp");
    var b = false;
    try {
        b = (d.habboHelp)
    } catch (a) {}
...
function ensureOpenerIsLoggedOut() {
    try {
        if (window.opener != null && window != window.opener && window.opener.document.doxLoggedIn != null) {
            if (window.opener.document.doxLoggedIn == true) {
    ...
    try {
        if (window.opener != null && window.opener != window) {
            if (window.opener.document.logoutPage != null && window.opener.document.logoutPage == true) {
                ...
                if (window.opener.document.doxLoggedIn != null && window.opener.document.doxLoggedIn == false) {
                    window.opener.location.replace(window.opener.location.href)
                }
            }
        }
...
TagHelper.addThisTagToMe = function (b, c, a) {
    ...
    new Ajax.Request("/myhabbo/tag/add", {
        parameters: "?tagName=" + encodeURIComponent(b),
...
TagFight.start = function () {
    ...
    $("fightanimation").src = doxStaticFilePath + "/images/tagfight/tagfight_loop.gif";
...
TagFight.newFight = function () {
    ...
    $("fightanimation").src = doxStaticFilePath + "/images/tagfight/tagfight_start.gif";
    $("tag1").value = "";
    $("tag2").value = ""
};
var Dialog = {
    ...
    createDialog: function (n, h, i, g, e, a, k) {
        ...
        if (a) {
            var o = Builder.node("a", {
                ...
                src: doxStaticFilePath + "/v2/images/close_x.gif",
                width: 15,
                height: 15,
                alt: ""
            })]);
...
var Overlay = {
    show: function (g, e) {
        ...
        if (e) {
            var f = new Image();
            f.src = doxStaticFilePath + "/v2/images/page_loader.gif";
            var b = c.parentNode.insertBefore(Builder.node("div", {
                id: "overlay_progress"
            }, [Builder.node("p", [Builder.node("img", {
                src: doxStaticFilePath + "/v2/images/page_loader.gif",
                alt: e
...
var ScriptLoader = {
    ...
    load: function (e, a) {
        ...
        if (!ScriptLoader.loaded[e]) {
            ...
            var d = a.path || doxStaticFilePath + "/js";
            b.src = d + "/" + e + ".js";
            if (a.callback) {
...
DoxView.add(function () {
    if (document.doxLoggedIn && $("subnavi-user")) {
        var b = new QuickMenu();
        var a = $A([
